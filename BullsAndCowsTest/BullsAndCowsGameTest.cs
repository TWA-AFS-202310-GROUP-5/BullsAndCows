...
namespace BullsAndCowsTest
{
    public class BullsAndCowsGameTest
    {
        ...
        [Theory]
        [InlineData("5643")]
        public void Should_return_0A2B_when_guess_given_digit_partial_correct_but_position_wrong(string guessNumber)
        {
            // given
            guessNumber = "5643";
            string secret = "1234";
        ...
        [InlineData("4231")]
        [InlineData("1324")]
        public void Should_return_2A2B_when_guess_given_digit_correct_position_partial_correct(string guessNumber)
        {
            // given
            guessNumber = "4231";
            string secret = "1234";
